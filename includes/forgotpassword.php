...
<div class="modal fade" id="forgotpassword">
  ...
  <div class="form-group">
                  <input type="text" name="mobile" class="form-control" placeholder="Your Reg. Mobile No." required="">
                </div>
  <div class="form-group">
  ...
  <div class="form-group">
              ...
              <div class="text-center">
                <p class="gray_text">Your password will be reset and a new one will be set.</p>
